...
#define LED_R_TRI()	HAL_GPIO_TogglePin(LED_R_GPIO_Port, LED_R_Pin)
...
#define LED_G_TRI()	HAL_GPIO_TogglePin(LED_G_GPIO_Port, LED_G_Pin)
...
#define LED_B_TRI()	HAL_GPIO_TogglePin(LED_B_GPIO_Port, LED_B_Pin)
