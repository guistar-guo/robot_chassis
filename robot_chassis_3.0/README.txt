...
************************robot_chassis2.9.3***********************
2024/8/19
1.完成富斯遥控（sbus）与ros指令同时控制小车，当两秒内富斯遥控未操作，则ros指令开始起作用
...
2024/8/21
1.修复了心跳灯颜色与预期不符的bug
2.新增了心跳灯反映底盘控制权归属的功能
3.修复了sbus协议长时间与富斯遥控器沟通时会失灵的bug

************************robot_chassis2.9.7***********************
2024/8/22
1.新增心跳灯蓝色模式：将拨码开关拨至3.3v开启蓝灯模式。富斯遥控和ros均无法控制，底盘速度冻结为0，方便调试其他部分代码。
2024/8/26
增加了user按钮，扫描模式消抖，待使用

************************robot_chassis3.0***********************
2024/8/30
完成了编码器速度的逆解算（麦轮）,并用于和ros通信的串口
2024/9/7
1，完成了速度标定，以及z轴的弧度标定
2，更新了底盘控制函数chassis_control，输入数据改为速度（mm/s）和角速度（1000rad/s）。并同步适配了fsi6_control和chassis_ros_control函数的内容
